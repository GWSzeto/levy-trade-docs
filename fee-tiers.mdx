...
Traders unlock permanent fee discounts ending at level 99, with each milestone reducing the base fee progressively. Achieving Level 98 permanently reduces your base fee to as low as 0.0250% (2.5bps).
...
Every individual trade also qualifies for a dynamic discount determined by its **effective leverage** (notional value / account equity). The discount grows linearly to a maximum of **4 bps at 40x leverage**.
...
Spot fees only apply on sells. Your spot sell fee equals your effective perp fee **multiplied by 2**. Using the example above, the same trader would pay **0.10%** when selling spot tokens (5 x 0.02%).
