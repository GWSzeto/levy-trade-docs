...
There is a 0.05% fee on futures trades, and a 0.5% fee on spot trades (only sells - there are no fees on spot buys). There is no fee on bridging or liquidations.

### Why haven't my bridged funds come through yet?

There is a minimum deposit limit of 10 USDC to initiate the bridging process. If you've deposited at least 10 USDC and have not received it on Levy Trade yet, run any command to initiate the bridging process.
