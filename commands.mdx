...
Buy and sell spot tokens. You must have USDC in your spot account to buy spot tokens. You can transfer USDC from your perps to spot account using the `/transfer` command if you are using a Levy Trade-managed wallet.
...
Taunt another clan with a message. You will be prompted to enter their clan name and a taunt, which can be text or a sticker.
